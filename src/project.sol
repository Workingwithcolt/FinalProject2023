...
contract TaskContract {
    ...
    uint public count_medicine  = 1;
    uint public count_medical = 1;
    uint256 public number_patients = 0;
    string chairperson_name public;
...
function getAllmedicine() public view returns(Medical_Medicine[] memory){
    ...
    function AddDocterName(string memory name) public{
        require(
            chairperson == msg.sender,
            "Only the Chairperson has  access "
        );
